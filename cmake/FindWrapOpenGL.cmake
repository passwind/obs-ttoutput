...
#
# Modified to remove AGL framework dependency for compatibility with newer Xcode SDKs
# where AGL has been deprecated and removed.
...
if (OpenGL_FOUND)
    ...
    if(APPLE)
        ...
        # AGL framework has been removed from newer Xcode SDKs
        # Only link OpenGL framework, which is sufficient for most use cases
        target_link_libraries(WrapOpenGL::WrapOpenGL INTERFACE ${__opengl_fw_path})
        
        # Note: AGL (Apple Graphics Library) was deprecated in macOS 10.9 and removed in newer SDKs
        # Modern applications should use Metal or other graphics APIs instead
        # For Qt6 applications, OpenGL framework alone is typically sufficient
    else()
